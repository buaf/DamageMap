...
class UfoUnit : public AbstractUnit
{
    Q_OBJECT
public:
    UfoUnit(QObject * parent = 0, qreal x_poss = 0, qreal y_poss = 0,b2World * world = NULL, int tankIDD = 0, QMap<int,AbstractUnit *> * UnitBase = NULL);
    ~UfoUnit();
