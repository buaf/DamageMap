...
BmpUnit::BmpUnit(QObject *parent, qreal x_poss, qreal y_poss, b2World * world, int tankIDD, QMap<int,AbstractUnit *> * UnitBase) :
...
void BmpUnit::drawUnit(qreal scale)
{
...
void BmpUnit::rotateGun(qreal num)
{
...
void BmpUnit::rotateBody(qreal num)
{
...
qreal BmpUnit::getxPos()
{
    return tankBody->GetPosition().x;
}

qreal BmpUnit::getyPos()
{
    return tankBody->GetPosition().y;
}

qreal BmpUnit::getBodyAnge()
{
    return tankBody->GetAngle();
}

qreal BmpUnit::getGunAnge()
{
    return gun_ange;
}
...
b2Body * BmpUnit::getBody()
{
    return tankBody;
}

int BmpUnit::addScore()
{
    return ++score;
}

int BmpUnit::healthMax()
{
    return 60;
}

int BmpUnit::setDamage(int num)
{
    health -= num;
    return health;
}

void BmpUnit::setTextures(int wheel_tex, int gun_tex, int head_tex, int body_tex)
{

}

QList<AbstractBullet *> * BmpUnit::getBulletBase()
{
    return BulletBase;
}


void BmpUnit::botGaming()
{
    int length = 10000;
